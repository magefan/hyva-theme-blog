...
> Hyva theme compatibility for the **Magefan Blog** extension is now available only in the **<a href="https://magefan.com/magento2-blog-extension/pricing#:~:text=hyva" target="_blank">Blog Plus and Extra<a/>** editions.<br/>
...
## Installation
```
composer require magefan/hyva-theme-blog
